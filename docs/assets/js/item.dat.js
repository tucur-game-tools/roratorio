(function () {
	...
	ItemObjNew = [
		...
		// XXX: 独自実装
		[4994,50,0,10,0,1,50,100,"アウェイキングブルーム","アウェイキングブルウム","",19,15,79,20,77,20,243,13,100074,2,7000262,15,7000269,15,7000015,10,7000016,10,9000007,10,9000062,25,9000269,25,0],
		...
		[5010,16,174,150,900003,1,150,220,"グレイシア風魔手裏剣","クレイシアフウマシユリケン","超越段階が1以上の時、精錬値が1上がる度に追加で、物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%（計算機未対応）",88,160,243,40,100080,6,100089,3,0],
		...
		[5014,17,173,70,900003,1,35,220,"グレイシアハンドガン","グレイシアハンドガン","超越段階が1以上の時、精錬値が1上がる度に追加で、物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%（計算機未対応）",243,40,100080,6,100089,3,0],
		...
		[5030,2,175,150,900003,1,120,220,"グレイシアベーシックソード","クレイシアヘエシツクソオド","超越段階が1以上の時、精錬値が1上がる度に追加で、物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%（計算機未対応）",88,130,243,40,100080,6,100089,3,0],
		[5031,9,202,150,900003,1,40,220,"グレイシアフォックステイル","クレイシアフオツクステイル","超越段階が1以上の時、精錬値が1上がる度に追加で、物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%（計算機未対応）",88,180,243,40,100080,6,100089,3,0],
	];
