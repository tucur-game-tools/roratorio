(function () {
	...
	ITEM_SP_TIME_OBJ = [
		...
		// XXX: 独自実装
		[263,"天与の才","Crt + 100",[[2,2892]],235,100,0],
		[264,"魔獣の爪牙","Pow + 100",[[2,2893]],230,100,0],
		[265,"根源への到達","Spl + 100",[[2,2894]],233,100,0],
		[266,"不滅の肉体","Sta + 100",[[2,2895]],231,100,0],
		[267,"叡智の王冠","Wis + 100",[[2,2896]],232,100,0],
		[268,"蒼穹の覇者","Con + 100",[[2,2897]],234,100,0],
		
		[269,"鳴り響く小太刀","闇属性魔法攻撃ダメージ + 50%",[[1,5144]],347,50,0]
	];
